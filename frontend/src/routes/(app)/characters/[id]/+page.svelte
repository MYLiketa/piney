<script lang="ts">
    ...
    $: {
        ...
        if (fromParam) {
            ...
            fromUrl = window.sessionStorage.getItem("charactersFromUrl") || "/characters";
        } else {
            fromUrl = "/characters";
        }
    }
    ...
    function goBack() {
        goto(fromUrl, { replaceState: true });
    }
...
>
    ...
    <div class="w-full md:w-32 flex-shrink-0 flex flex-col gap-4">
        <Button variant="ghost" class="w-fit -ml-2 mb-2" onclick={goBack}>
